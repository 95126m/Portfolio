      ...
      <div css={contentStyle}>
        <motion.div
          ...
          <div className="fourth-section">
            <h2>작업 기여도</h2>
            <li>
              맡은 페이지를 정해진 기간보다 앞당겨 작업을 마친 뒤, 도움이 필요한
              팀원들의 페이지를 맡아 수행하였습니다.
            </li>
            <li>
              공통 컴포넌트를 다른 팀원들이 사용하기 쉽도록 여러 조건들을 세분화
              해 작업하였습니다.
            </li>
            <li>
              백엔드 측의 요구사항을 열린 마음으로 받아들이며 수용하였습니다.
            </li>
            <li>
              유저플로우를 최대한 상세하게 작업하여, 개발 진행에 있어 수월하도록
              하였습니다.
            </li>
          </div>
